...
Nightwatch.prototype.terminate = function(deferred) {
  // TODO: used to be at bottom of this fn, but could not be checked in sync terminateSession callbacks. is this OK?
  ...
  if (deferred) {
    this.queue.instance().once('queue:started', this.terminateSession.bind(this)); // TODO: abolish deferred?
  } else {
...
Nightwatch.prototype.terminateSession = function() {
  ...
  if (this.endSessionOnFail() && this.options.start_session) {
    console.log('AUTO-ENDING SESSION...', new Error().stack);
    this.api.end(function() {
      console.log('AUTO-ENDING SESSION END');
      this.finished();
    }.bind(this));
