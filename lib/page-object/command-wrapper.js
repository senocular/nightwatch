    ...
    return function() {
      ...
      if (isElementCommand) {
        ...
        if (ancestors.length === 1) {
          ...
          firstArg = {
            selector: elementOrSection.selector,
            index: elementOrSection.index
          };

          // TODO: if we give the locateStrategy to the selector
          // object, does that negate the need to restore it here?
